...
const BASE_URL_Discovery_token =
...
const link = {
  "media-url":
    "https://raw.githubusercontent.com/KOP-XIAO/QuantumultX/master/img/southpark/7.png"
};
        ...
        if (response.statusCode == 200) {
          ...
          $task.fetch(option1).then(
            (response) => {
              ...
              let data = JSON.parse(response.body);
              let locationd =
                data["data"]["attributes"]["currentLocationTerritory"];
              if (locationd == "us") {
